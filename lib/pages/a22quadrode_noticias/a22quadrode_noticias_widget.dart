...
export 'a22quadrode_noticias_model.dart';

class A22quadrodeNoticiasWidget extends StatefulWidget {
  ...
  @override
  State<A22quadrodeNoticiasWidget> createState() =>
      _A22quadrodeNoticiasWidgetState();
}

class _A22quadrodeNoticiasWidgetState extends State<A22quadrodeNoticiasWidget>
    with TickerProviderStateMixin {
  late A22quadrodeNoticiasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => A22quadrodeNoticiasModel());
                          ...
                          children: [
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Padding(
                                                                              padding: EdgeInsetsDirectional.fromSTEB(15.0, 25.0, 0.0, 15.0),
                                                                              child: FFButtonWidget(
                                                                                onPressed: () async {
                                                                                  if (_model.formKey.currentState == null || !_model.formKey.currentState!.validate()) {
                                                                                    return;
                                                                                  }
                                                                                  if (_model.categoriaLivroValue1 == null) {
                                                                                    await showDialog(
                                                                                      context: context,
                            ...
                            if (widget!.telas == 'calendario')
                              Align(
                                ...
                                child: Container(
                                  width:
                                      MediaQuery.sizeOf(context).width * 0.765,
                                  height: double.infinity,
                                  decoration: BoxDecoration(
                                    color: FlutterFlowTheme.of(context)
                                        .secondaryBackground,
